...
return [
    ...
    */
    ...
    'phone' => 'A megadott telefonszám helytelen!',
    ...
    */
    ...
    'required_contact_informations' => 'A kiválasztott cím minden kötelező elemét ki kell tölteni.',
    ...
    'incorrect_current_password' => 'A jelenlegi jelszó nem megfelelő!',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'addresses.*.zip_code' => 'irányítószám',
        'addresses.*.city' => 'város',
        'addresses.*.address' => 'cím',
        'addresses.*.phone' => 'telefon',
        'addresses.*.email' => 'email',
        'addresses.*.comment' => 'megjegyzés',
        'city' => 'város',
        'zip' => 'irányítószám',
        'country' => 'város',
        'company_name' => 'cégnév',
