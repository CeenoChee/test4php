<div class="product-sum-box top-[180px] w-[300px] right-0 bg-white p-4 pt-2 ml-auto mt-8">
    ...
    <div class="prices">
        ...
        <table class="w-full table-fixed text-xs">
            <tr class="">
                ...
                <td class="pl-2 py-2">
                    <span class="sum-price-text text-gray-500 font-semibold">{{ Fct::price($cart->getItemAmount()) }}</span>
            ...
            <tr class="">
                ...
                <td class="pl-2 py-2">
                    <span class="sum-price-text text-gray-500  shipping-price-text font-semibold">{{ Fct::price($cart->getShipmentAmount()) }}</span>
                    <span class="text-2xs text-gray-400">+ @lang('prices.vat')</span>
                </td>
            </tr>
            <tr class="">
        ...
        <div class="border-t border-solid border-neutral-200 font-bold mb-4">
            ...
            <div>
                <span class="sum-price-text text-riel-light text-2lg">{{ Fct::price($cart->getTotal()) }}</span>
                <span class="text-2xs text-gray-400">+ @lang('prices.vat')</span>
            </div>
        </div>
        ...
        <div class="mt-2">
            <a href="{{$nextUrl}}" class="!bg-green-500 hover:bg-green-600 w-48 mx-auto btn">@lang('form.next')</a>
        </div>
